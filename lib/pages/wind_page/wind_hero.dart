...
class WindHero extends StatelessWidget {
  const WindHero({
    super.key,
  ...
  Widget build(BuildContext context) {
    if (!onMobile) {
          ...
          children: [
            Align(
                ...
                child: Container(
                  ...
                  // height: 100,
                  // width: 100,
                  child: Lottie.asset('assets/animation/wind_hero_animation.json'),
                )),
            Align(
      ...
      return Padding(
        ...
        child: Column(
          children: [
            Lottie.asset('assets/animation/wind_hero_animation.json'),
            Text(
              heroTitleString,
              style: GoogleFonts.tinos(
                textStyle: TextStyle(

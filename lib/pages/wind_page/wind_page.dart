        ...
        body: ListView(
          children: [
            ...
            ElementGroupWidget(
                ...
                width: width,
                height: height,
                costSavingImage: siteSelectionImage,
                costSavingTitle: siteSelectionTitle,
                costSavingContent: siteSelectionContent),
            const Divider(
              thickness: 5,
              color: thirtyUIColor,
              indent: sectionGapPadding,
            ...
            ElementGroupWidget(
                ...
                width: width,
                height: height,
                costSavingImage: maintainanceImage,
                costSavingTitle: maintainanceTitle,
                costSavingContent: maintainanceContent),
          ],
        ),
      );
    } else {
